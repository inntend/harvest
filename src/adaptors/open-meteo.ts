...
export const openMeteoAdaptor: Adaptor<typeof config.shape> = {
  ...
  def: {
    ...
    read: {
      ...
      wind_direction_10m: { unit: '°', min: 0, max: 360 },
      wind_direction_80m: { unit: '°', min: 0, max: 360 },
      wind_direction_120m: { unit: '°', min: 0, max: 360 },
      wind_direction_180m: { unit: '°', min: 0, max: 360 },
      ...
      // Solar radiation
      shortwave_radiation: { unit: 'W/m²', min: 0 },
      shortwave_radiation_instant: { unit: 'W/m²', min: 0 },
      direct_radiation: { unit: 'W/m²', min: 0 },
      direct_radiation_instant: { unit: 'W/m²', min: 0 },
      diffuse_radiation: { unit: 'W/m²', min: 0 },
      diffuse_radiation_instant: { unit: 'W/m²', min: 0 },
      direct_normal_irradiance: { unit: 'W/m²', min: 0 },
      direct_normal_irradiance_instant: { unit: 'W/m²', min: 0 },
      terrestrial_radiation: { unit: 'W/m²', min: 0 },
      terrestrial_radiation_instant: { unit: 'W/m²', min: 0 },
      ...
      soil_moisture_0_to_1cm: { unit: 'm³/m³', min: 0, max: 1 },
      soil_moisture_1_to_3cm: { unit: 'm³/m³', min: 0, max: 1 },
      soil_moisture_3_to_9cm: { unit: 'm³/m³', min: 0, max: 1 },
      soil_moisture_9_to_27cm: { unit: 'm³/m³', min: 0, max: 1 },
      soil_moisture_27_to_81cm: { unit: 'm³/m³', min: 0, max: 1 },
      ...
      daily_wind_direction_10m_dominant: { unit: '°', min: 0, max: 360 },
      daily_shortwave_radiation_sum: { unit: 'MJ/m²', min: 0 },
